<?php
/*
$Id: products_viewed.php 1857 2012-06-20 01:21:38Z michael.oscmax@gmail.com $
    ...
    <tr>
      <td valign="top">
        <table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          ?>
          <tr class="dataTableRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_CATEGORIES, 'action=new_product&amp;&amp;pID=' . $products['products_id'] . '&amp;origin=' . FILENAME_STATS_PRODUCTS_VIEWED, 'NONSSL'); ?>'">
            <td class="dataTableContent"><?php echo $rows; ?>.</td>
            <td class="dataTableContent"><?php echo '<a href="' . tep_href_link(FILENAME_CATEGORIES, 'action=new_product&amp;pID=' . $products['products_id'] . '&amp;origin=' . FILENAME_STATS_PRODUCTS_VIEWED, 'NONSSL') . '">' . $products['products_name'] . '</a>'; ?></td>
