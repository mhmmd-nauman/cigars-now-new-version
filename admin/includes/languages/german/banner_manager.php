...
define('TEXT_BANNERS_NEW_GROUP', ', oder geben Sie eine neue Banner-Gruppe ein'); 
define('TEXT_BANNERS_IMAGE', 'Bild:'); 
define('TEXT_BANNERS_IMAGE_LOCAL', ', oder geben Sie unten die lokale Datei an'); 
define('TEXT_BANNERS_IMAGE_TARGET', 'Bildziel (Speichern nach):'); 
define('TEXT_BANNERS_HTML_TEXT', 'HTML Text:');
define('TEXT_BANNERS_EXPIRES_ON', 'Ablaufdatum:');
define('TEXT_BANNERS_OR_AT', ', oder bei');
define('TEXT_BANNERS_IMPRESSIONS', 'Impressionen/Anzeigen.');
define('TEXT_BANNERS_SCHEDULED_AT', 'Geplant ab:');
define('TEXT_BANNERS_BANNER_NOTE', '<b>Banner Bemerkung:</b><ul><li>Sie können Bild- oder HTML-Text-Banner verwenden, beides gleichzeitig ist nicht möglich.</li><li>Wenn Sie beide Bannerarten gleichzeitig verwenden, wird nur der HTML-Text Banner angezeigt.</li><li>Bei einer Verlinkung auf eine externe Website muss <b>http://</b> angegeben werden.</li></ul>');
define('TEXT_BANNERS_GROUP_NOTE', '<b>Banner-Gruppen:</b><ul><li>Alle - Anzeige im Footer</li><li>Index - Anzeige auf der Indexseite im Hauptinhaltsbereich</li><li>Produkt - Anzeige auf der product_info Seite</li><li>Sie können die Sortierreihenfolge unter Einstellungen -> Templates -> Seitenmodule ändern</li></ul>');
define('TEXT_BANNERS_INSERT_NOTE', '<b>Bemerkung:</b><ul><li>Das Bildverzeichnis muss beschreibbar sein!</li><li>Füllen Sie das Feld \'Bildziel (Speichern nach)\' nicht aus, wenn Sie kein Bild auf Ihren Server kopieren m&ouml;chten (z.B. wenn sich das Bild bereits auf dem Server befindet).</li><li>Das \'Bildziel (Speichern nach)\' Feld muss ein bereits existierendes Verzeichnis mit \'/\' am Ende sein (z.B. banners/).</li></ul>'); 
...
define('TEXT_BANNERS_SCHEDULED_AT_DATE', 'Geplant ab: <b>%s</b>');
define('TEXT_BANNERS_EXPIRES_AT_DATE', 'Ablaufdatum: <b>%s</b>');
define('TEXT_BANNERS_EXPIRES_AT_IMPRESSIONS', 'Ablauf nach: <b>%s</b> Impressionen');
...
define('SUCCESS_BANNER_INSERTED', 'Erfolg: Das Banner wurde eingefügt.');
define('SUCCESS_BANNER_UPDATED', 'Erfolg: Das Banner wurde aktualisiert.');
define('SUCCESS_BANNER_REMOVED', 'Erfolg: Das Banner wurde gelöscht.');
...
define('ERROR_BANNER_GROUP_REQUIRED', 'Fehler: Eine Bannergruppe ist erforderlicht.');
define('ERROR_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Fehler: Das Zielverzeichnis %s existiert nicht.');
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Fehler: Das Zielverzeichnis %s ist schreibgeschützt.');
...
define('TEXT_BANNERS_HELP', 'Banner Manager Hilfe');
?>