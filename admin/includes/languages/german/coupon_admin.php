...
define('COUPON_NAME_HELP', 'Kurzbezeichnung des Aktionsutscheines');
...
define('ERROR_MISSING_COUPON_NAME', 'Fehler: Sie haben keinen Gutscheinnamen vergeben in der Sprache ');
