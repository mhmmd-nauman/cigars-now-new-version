...
define('HINT_TOTALS', 'Puedes concede descuentos introduciendo vaores negativos. El subtotal, impuestos y total no son editables. Cuando añadas conceptos vía AJAX asegúrate de introducir primero el nombre o el programa no reconocerá la entrada (es decir, un concepto con un nombre en blanco será eliminado del pedido).');
